...
```http
POST https://api.simcel.io/api/oauth/v1/token
...
```http
POST https://api.simcel.io/api/auth/v1/token
...
```http
GET https://api.simcel.io/api/insights/v1/pnl-summary?planId=...
...
class SimcelClient:
    ...
    def _get_token(self) -> str:
        ...
        resp = requests.post(
            "https://api.simcel.io/api/auth/v1/token",
    ...
    def get(self, path: str, **kwargs):
        ...
        return requests.get(
            f"https://api.simcel.io/api/insights/v1{path}",
            headers=headers,
            **kwargs
        )
```
