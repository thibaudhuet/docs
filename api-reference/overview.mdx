...
<CardGroup cols={2}>
  <Card title="Demand Forecast" icon="chart-line" href="/api-reference/demand-forecast">
    Demand volume, value, fill rate, and forecast accuracy over time
  </Card>
  <Card title="P&L Summary" icon="dollar-sign" href="/api-reference/pnl-summary">
    Full Profit & Loss stack from Gross Sales down to EBIT and DPM
  </Card>
  <Card title="Supply Performance" icon="warehouse" href="/api-reference/supply-performance">
    Closing stock, service levels, dispatch volumes by DC or SKU
  </Card>
  <Card title="Sustainability" icon="leaf" href="/api-reference/sustainability">
    CO2 footprint broken down by inbound, storage, and outbound
  </Card>
</CardGroup>
