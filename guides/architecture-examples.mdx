...
resp = requests.get(
    "https://api.simcel.io/insights/v1/demand-forecast",
...
<Note>
  All patterns share the same SIMCEL API credentials and rate limits. For high-volume integrations like ERP sync running multiple times per day, consider the **Growth** or **Enterprise** plan. See [Pricing](/pricing).
</Note>
